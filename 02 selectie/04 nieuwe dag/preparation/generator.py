...
# generate test data
ntests = 25
cases = [(31, 12, 2025), (28,2,2025), (5, 5, 2002), (31,8,2050), (31,7,1998), (30,4,1986)]
while len(cases) < ntests:
    dag = random.randint(1,31)
    maand = random.randint(1,12)
    jaar = random.randint(1900,2100)
    
    if is_valid(dag, maand) and not is_schrikkeljaar(jaar):
        case = (dag, maand, jaar)
        if case not in cases:
            cases.append( case) 

cases = sorted(cases, key = lambda x: (x[2], x[1], x[0]))
