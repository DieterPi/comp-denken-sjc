...
klassen = ['3LA1','3LA2','3LA3','3ECWE','3HUWE','3NAWE1','3NAWE2','3NAWE3','3GRLA','3SPWE','3MT']
ntests= 20
cases = [('Jan','3LA1'),]
while len(cases) < ntests:
    cases.append( (jongens[random.randint(0,len(jongens)-1)], klassen[random.randint(0,len(klassen)-1)]) )
