...
![Een schema met de viervouden plus 1.](media/image.png "Een schema met de viervouden plus 1."){:data-caption="Een schema met de viervouden plus 1." .light-only height="200px"}

![Een schema met de viervouden plus 1.](media/image_dark.png "Een schema met de viervouden plus 1."){:data-caption="Een schema met de viervouden plus 1." .dark-only height="200px"}
