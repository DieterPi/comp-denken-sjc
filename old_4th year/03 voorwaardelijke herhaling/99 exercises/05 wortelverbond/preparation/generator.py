...
# generate test data
ntests= 20
cases = [('Augustus De Morgan',1806), ('Albert Einstein', 1879), ('Harry Styles', 1994), ('Jake Gyllenhaal', 1980), 
         ('Karel de Slechte', 1332), ('Charles Atlas', 1892), ('Thomas Alva Edison',1847), ('Leonard Euler',1707), 
         ('Frederik Barbarossa',1122), ('Emma Bale',1999), ('Free Souffriau', 1980)]
