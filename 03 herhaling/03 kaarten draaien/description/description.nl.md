...
![Startsituatie.](media/step0.png "Startsituatie."){:data-caption="Startsituatie." width="400px"}
...
![Situatie na één stap.](media/step1.png "Situatie na één stap."){:data-caption="Situatie na één stap." width="400px"}

Na **twee** stappen liggen alle kaarten met de blauwe kant naar boven, behalve de tweede van rechts:

![Situatie na twee stappen.](media/step2.png "Situatie na twee stappen."){:data-caption="Situatie na twee stappen." width="400px"}
...
![Situatie na drie stappen.](media/step3.png "Situatie na drie stappen."){:data-caption="Situatie na drie stappen." width="400px"}
