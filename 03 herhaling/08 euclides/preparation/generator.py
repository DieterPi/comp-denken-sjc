...
# generate test data
ntests= 30
cases = [(28,16),(16,28), (1140,900), (253,759), (50,65), (372,752), (752,372),(105,252)]
while len(cases) < ntests:
    case = tuple(random.randint(25,1500) for _ in range(2))
    ggd = math.gcd(case[0], case[1])
    if random.randint(0,5) == 0 or ggd >5:
