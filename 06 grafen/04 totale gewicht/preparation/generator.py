...
# generate test data
ntests = 20
cases = [ [('A', 'B', 3), ('B','C', 4), ('C', 'A', 2), ('C', 'D', 2), ('D', 'B', 7), ('B', 'E', 8)] ]

while len( cases ) < ntests:
    graph = construct_graph(connected = False, weight = 25)
    cases.append( graph['E'] )
...
for test in cases:
    ...
    expression_name = 'gewicht( {} )'.format( test )
    result = module.gewicht( test )
