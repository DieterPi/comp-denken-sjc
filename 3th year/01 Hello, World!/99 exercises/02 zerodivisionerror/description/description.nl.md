Als er iets fout zit in code, geeft Python meestal een foutmelding. Dit zijn vaak **syntax fouten**, die aangeven dat er iets fout zit in de **vorm** van je code. Bijvoorbeeld indien je een haakje vergeten bent.
